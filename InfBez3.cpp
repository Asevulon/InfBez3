...
// InfBez3.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CInfBez3App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CInfBez3App

CInfBez3App::CInfBez3App()
{
...
// Единственный объект CInfBez3App

CInfBez3App theApp;


// Инициализация CInfBez3App

BOOL CInfBez3App::InitInstance()
{
